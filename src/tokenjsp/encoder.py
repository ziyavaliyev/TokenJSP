"""
Graph encoders used for GAE and VGAE experiments.
"""
...
def make_conv(
    ...
    """Shared factory for all supported GNN layers."""
...
class VariationalEncoder(nn.Module):
    """Variational encoder producing mean and log-standard-deviation."""
    def __init__(
        self,
        in_channels: int,
        hidden_channels: int,
